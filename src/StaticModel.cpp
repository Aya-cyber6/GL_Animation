...
Mesh StaticModel::processMesh(aiMesh* mesh, const aiScene* scene)
{
    ...
    std::vector<Texture0> diffuseMaps = loadMaterialTextures(material, aiTextureType_DIFFUSE, "texture_diffuse");
...
std::vector<Texture0> StaticModel::loadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName)
{
    std::vector<Texture0> textures;
